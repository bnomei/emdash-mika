...
describe("Mika Astro template contracts", () => {
  ...
  it("ships the Kumo app shell around copied pages", () => {
    ...
    expect(frame).toContain('aria-label="Account sections"');
    expect(frame).toContain("mika-kumo-mobile-account-links");
    ...
    expect(frame).not.toContain("useSidebar");
    expect(frame).not.toContain("MobileSidebarTrigger");
    expect(frame).not.toContain("Sidebar.Trigger");
    expect(frame).not.toContain("Sidebar.Rail");
    expect(frame).not.toContain("Sidebar.ResizeHandle");
    expect(frame).not.toContain("peekable");
    expect(frame).not.toContain("resizable");
    ...
    expect(styles).toContain(".mika-kumo-mobile-account-links");
  ...
  it("keeps standalone grouped add-to-cart forms locally synchronized", () => {
    ...
    expect(addToCartSyncSource).toContain("(event as CustomEvent<MikaVariantChangeDetail>).detail");
