...
- Commit one locked release-consumer lane using Node 22.13.0, npm 11.16.0, Astro 7.2.0, Sharp 0.35.3, and EmDash 0.22.0. Install the exact optional peers required by the imported subpaths: Kumo 2.5.2, Phosphor Icons React 2.1.10, React 19.2.7, and React DOM 19.2.7. Expand this lane only when compatibility or security problems justify it.
