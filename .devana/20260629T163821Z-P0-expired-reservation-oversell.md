...
DEVANA-KEY: src/storage/repositories.ts:1739 | expired-reservation-oversell
DEVANA-SUMMARY: open | P0 | high | Releasing expired reservations frees stock for new reserves while late payment can still consume the expired hold, enabling oversell.